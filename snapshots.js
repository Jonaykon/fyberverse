const todo_fix=[999,998,997,996,995,994,993,992,991,990,989,988,987,986,985,984,983,982,981,980,979,978,977,976,909,904,896,890,880,868,859,858,856,855,854,853,852,851,850,849,848,847,830,829,788,787,786,785,784,783,782,781,780,779,778,777,776,775,773,762,761,760,759,752,751,721,720,719,698,691,686,666,665,664,663,662,661,660,659,658,657,656,655,654,653,652,651,650,649,648,647,646,645,644,643,642,641,640,616,615,614,613,612,611,610,609,608,595,594,592,585,554,551,544,540,531,529,497,496,495,494,493,492,491,490,489,488,487,486,485,484,483,482,481,480,436,433,432,388,384,378,373,367,357,306,305,304,303,302,301,300,299,298,297,296,295,294,293,292,291,290,289,288,287,286,285,284,283,282,281,280,279,278,277,276,275,255,244,243,226,208,180,179,172,160,158,146,144,136,125,109,93,91,77,76,75,71,62,61,60,59,58,57,56,55,54,53,52,51,50,49,48,47,46,45,44,43,42,41,40,39,38,37,36,35,34,33,32,30,25,24,20,19,18,17,16,15,14,13,12,9,8,3,2];
...
function getTitle(item) {
    return item.post.record.text.replace("8DAY ", "").replace("DAY ", "").split(" - ").slice(1).join(" - ");
}
    ...
    async function fetchPosts(actorHandle) {
        ...
        try {
            ...
            const filtered = sorted.filter((item) => {
                ...
                if (todo_fix.includes(getNum(item))) return false;
                return true;
            })
